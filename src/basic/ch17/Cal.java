...
class Cal2 extends Cal {
	...
	// 오버라이드 처리 한다. > 자식이 부모의 메서드를 덮는다.
//	public int multiply(int n1, int n2) {
//		// a 또는 b --> 논리 연산자 (논리 합 || ) --> 둘 중 하나라도 true라면 --> true 이다.
...
//	}
	...
	@Override // <-- 애노테이션, 어노테이션 표기법 이라 부른다. --> 주석 + 힌트
	public int multiply(int n1, int n2) {
		System.out.println("1. 호출");
		return super.multiply(n1, n2); // super : 부모 클래스를 뜻 함
	}
}
