...
public class IntArrayQueue {
	...
	public int dequeue() {
		int item = -9999;
		if (isEmpty()) {
			System.out.println("큐 메모리 공간에 요소가 존재하지 않음");
		} else {
			...
			// 200, 300, 0
			// 마지막 요소를 초기화 처리한다. ( 한 칸씩 앞으로 꺼내 땡겼으니까)
			array[rear] = 0;
			rear--;
			size--;
	...
	public static void main(String[] args) {
		...
		// 데이터 꺼내고 삭제 처리
		// queue.dequeue(); // 맨 처음 들어온 것 부터 꺼내지고 삭제 처리 된다.
